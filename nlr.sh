...
java -jar NLR-Annotator/NLR-Annotator-v2.1b.jar -i ../Genome/Nomenclature_Update/farr1_updated.fa -x NLR-Annotator/src/mot.txt -y NLR-Annotator/src/store.txt -o nlr.out.txt -g nlr.out.gff -a nlr.motif.msa.fa

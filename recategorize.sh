...
cat DAfiles/all_ct.txt DAfiles/all_ctn.txt DAfiles/all_ctnl.txt DAfiles/nnl_tn.txt DAfiles/nnl_tnl.txt | awk '{print $1}' > nnlgenelist.txt
...
cat DAfiles/all_ct.txt DAfiles/all_ctn.txt DAfiles/all_ctnl.txt | awk '{print $1}' > nnl_type1_genelist.txt
cat DAfiles/nnl_tn.txt DAfiles/nnl_tnl.txt | awk '{print $1}' > nnl_type2_genelist.txt
